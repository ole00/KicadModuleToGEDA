...
//		if ((gEDAdeltaAngle > 359) || (gEDAdeltaAngle < -359))
		...
		// having established the start angle in gEDA degrees, and diameter in 0.01mil units,
		...
		// point (xDir, yDir)
		// and apply the magnificationRatio while we are at it

                radiusNm = magnificationRatio*Math.sqrt((xDir*xDir) + (yDir*yDir));

                // we now convert the radius in Kicad 0.1 mil units to a gEDA 0.01 mil unit diameter
